...
ARCHIVO_LOCAL="/home/miguel/backup_bd/playhitsgame-$CURRENT_DATE.sql.gz"  # Archivo local a subir
...
cd $RUTA_REMOTA
mdelete *
put $ARCHIVO_LOCAL $NOMBRE_ARCHIVO
bye
EOF

echo "El archivo $ARCHIVO_LOCAL ha sido subido a $RUTA_REMOTA en $FTP_HOST"
