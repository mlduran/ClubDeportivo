...
public class MovimientoDAO extends ObjetoDAO {
    ...
    protected String schema(){return "clubdeportivo" + MovimientoDAO.getEntorno();}
    protected String nombreTabla() {
        return TablasDAO.movimientos.name();
    }
    ...
    protected Object crearObjeto(ResultSet retorno)
        ...
        obj.setClase(ClaseMovimiento.values()[(retorno.getInt("clase"))]);
    ...
    protected PreparedStatement asignarCampos(PreparedStatement sql, Object obj,
        ...
        Movimiento objMov = (Movimiento) obj;
        ...
        if (tipo == TipoSaveDAO.update) sql.setLong(6, objMov.getId());
