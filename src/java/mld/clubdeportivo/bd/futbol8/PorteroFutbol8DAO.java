...
public class PorteroFutbol8DAO extends ObjetoDAO{
    ...
    protected String schema(){return "futbol8" + PorteroFutbol8DAO.getEntorno();}

    protected String nombreTabla() {
        return TablasDAO.porterosfutbol8.name();
    }
    ...
    protected PreparedStatement asignarCampos(PreparedStatement sql, Object obj,
        ...
        PorteroFutbol8 objGol = (PorteroFutbol8) obj;
    ...
    protected Object crearObjeto(ResultSet retorno)
        ...
        PorteroFutbol8 obj = new PorteroFutbol8();
