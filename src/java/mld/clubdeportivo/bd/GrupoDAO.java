...
public class GrupoDAO extends ObjetoDAO {
    ...
    protected String schema(){return "clubdeportivo" + GrupoDAO.getEntorno();}
    protected String nombreTabla() {
        return TablasDAO.grupos.name();
    }
    ...
    protected Grupo getGrupoByNombre(String nombre) throws DAOException {
        ...
        Grupo obj = (Grupo) getDataObject(txtsql, nombre);
    ...
    protected Grupo getGrupoByIp(String ip) throws DAOException {
        ...
        String txtsql = "SELECT * FROM " + nombreTabla() + " WHERE ip = ?";

        Grupo obj = (Grupo) getDataObject(txtsql, ip);
    ...
    protected List<Grupo> getGrupos(boolean activo) throws DAOException {
        ...
        String txtsql = "SELECT * FROM " + nombreTabla() + "  WHERE activo = ?";
     ...
     protected List<Grupo> getGruposDisponibles() throws DAOException {
        ...
        String txtsql = "SELECT * FROM " + nombreTabla() + "  WHERE activo = true AND"
                + " completo = false";
    ...
    protected List<Club> getClubs(Grupo grp)
        ...
        String txtsql = "SELECT * FROM clubs WHERE "
    ...
    protected PreparedStatement asignarCampos(PreparedStatement sql, Object obj,
        ...
        if (tipo == TipoSaveDAO.update) sql.setLong(9, objGrupo.getId());
