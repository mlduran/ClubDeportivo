...
public abstract class ObjetoDAO {
    ...
    private static Logger logger = LogManager.getLogger(ObjetoDAO.class);
    ...
    protected List<Object> getDataObjects(String txtsql, ArrayList params)
        ...
        logger.debug(txtsql);
        if (params != null) logger.debug(params.toString());
    ...
    protected double queryNumerica(String txtsql, TipoRetornoDAO tipoRetorno, 
        ...
        logger.debug(txtsql);
        logger.debug(tipoRetorno.toString());
