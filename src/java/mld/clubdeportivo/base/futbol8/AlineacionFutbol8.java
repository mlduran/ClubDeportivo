...
public final class AlineacionFutbol8 extends Alineacion {
    ...
    public ArrayList<JugadorFutbol8> jugadores(){
        ...
        ArrayList<JugadorFutbol8> lista = jugadoresCampo(); 
    ...
    public ArrayList<JugadorFutbol8> defensas(){
        ...
        for (JugadorFutbol8 jug : jugadoresCampo())             
    ...
    public JugadorFutbol8 jugadorParaPaseMismaLinea(String cuadrante){
        ...
        ArrayList<JugadorFutbol8> posibles = new ArrayList<JugadorFutbol8>();
    ...
    public JugadorFutbol8 jugadorParaPase(String cuadrante){
        ...
        JugadorFutbol8 jugP = null;
        ArrayList<JugadorFutbol8> posiblesA = new ArrayList<JugadorFutbol8>();
        ArrayList<JugadorFutbol8> posiblesB = new ArrayList<JugadorFutbol8>();
    ...
    public void validarAlineacion(){
        ...
        if (this.getPortero() != null)
            if (!this.getPortero().isPuedeJugar() ||              
                    this.getPortero().getPosicion() != PosicionJugFutbol8.Portero){
        ...
        if (this.getJugador1() != null)
            if (!this.getJugador1().isPuedeJugar() ||
                    this.getJugador1().getPosicion() == PosicionJugFutbol8.Portero){
        ...
        if (this.getJugador2() != null)
            if (!this.getJugador2().isPuedeJugar() ||
                ...
                this.getJugador2().getPosicion() == PosicionJugFutbol8.Portero){
        ...
        if (this.getJugador3() != null)
            if (!this.getJugador3().isPuedeJugar() ||
                ...
                this.getJugador3().getPosicion() == PosicionJugFutbol8.Portero){
        ...
        if (this.getJugador4() != null)
            if (!this.getJugador4().isPuedeJugar() ||
                ...
                this.getJugador4().getPosicion() == PosicionJugFutbol8.Portero){
        ...
        if (this.getJugador5() != null)
            if (!this.getJugador5().isPuedeJugar() ||
                ...
                this.getJugador5().getPosicion() == PosicionJugFutbol8.Portero){
        ...
        if (this.getJugador6() != null)
            if (!this.getJugador6().isPuedeJugar() ||
                ...
                this.getJugador6().getPosicion() == PosicionJugFutbol8.Portero){
        ...
        if (this.getJugador7() != null)
            if (!this.getJugador7().isPuedeJugar() ||
                ...
                this.getJugador7().getPosicion() == PosicionJugFutbol8.Portero){
    ...
    public boolean setDato(String posicion, JugadorFutbol8 jug){
        ...
        ArrayList<JugadorFutbol8> jugadores = this.jugadores();
        boolean isAliniado = false;
        for (JugadorFutbol8 jugAlineado : jugadores) {
   ...
   public static ArrayList<JugadorFutbol8> parseAlineacion(String txt){
       ...
       ArrayList<JugadorFutbol8> alineacion = new ArrayList<JugadorFutbol8>();
       ...
       for (String datos : txt.split("&&")[0].split("&")) {
           ...
           if (dato.length == 5){
               ...
               jug.setPosicion(PosicionJugFutbol8.valueOf(dato[1]));
