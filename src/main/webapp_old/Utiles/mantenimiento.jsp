...
<html>
    ...
    <body>
        ...
        <div id="columna_central_login">
            ...
            <p class="titulo1"> SE ESTAN REALIZANDO TRABAJOS DE MANTENIMIENTO EN LA WEB .... <br/>
            EN BREVES MOMENTOS PODRAS ACCEDER</p> 

           <p class="ayuda">${texto}</p>           
           <img align="middle" src="${root}/images/mantenimiento.png" title="Mantenimiento" alt="Mantenimiento"/>
