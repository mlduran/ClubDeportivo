...
public class LanzarJornadaHttpServlet {
    ...
    private String processRequest(HttpServletRequest req, HttpServletResponse resp)
        ...
        var dir = "/Utiles/jornadaOK";
        var txtMail = "";

        System.out.println("Se lanza la jornada de ClubDeportivo");
        ...
        try {
            ...
            if ((entorno == null || (entorno != null && !entorno.equals("desarrollo"))) && !comprobarLanzamiento(req, resp)) {
                ...
                txtMail = "La configuracion del lanzamiento no es correcta"
                        + "<br/>URL de llamada: " + req.getRequestURL()
    ...
    private boolean comprobarLanzamiento(HttpServletRequest req,
        ...
        System.out.println("Simulando: " + appManager.getAttribute("simulando"));
        System.out.println("Fecha: " + fechaUltimoLanzamiento);
