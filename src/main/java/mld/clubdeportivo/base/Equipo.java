...
public abstract class Equipo extends Seccion
    ...
    public int ingresoPublicidad(int porcentajeHacienda){
        ...
        var ingreso = this.getPublicidad() * valorAleatorio(CANTIDAD_BASE);
        var hacienda = ingreso * porcentajeHacienda / 100;
    ...
    public int rescatarBolsa(){
        ...
        var cantidad = (int) (this.getBolsa() - (this.getBolsa() * 0.1));
        this.setPresupuesto(this.getPresupuesto() + cantidad);
        this.setBolsa(0); 
    ...
    public int getValorPxoximaAmpliacionCampo(){
        var cantidad =  this.getCampo() * 5 + CANTIDA_RELATIVA;
    ...
    public int ampliarCampo(){
        ...
        var precio = this.getValorPxoximaAmpliacionCampo();
    ...
    public int ampliarPublicidad(){
        ...
        var precio = this.getValorPxoximaAmpliacionPublicidad();
    ...
    public int ampliarEqTecnico(){
        ...
        var precio = this.getValorPxoximaAmpliacionEqTecnico();
    ...
    public int ampliarOjeadores() {
        ...
        var precio = this.getValorPxoximaAmpliacionOjeadores();
    ...
    public int getCosteJugadores(){
        ...
        var coste = 0;
        for (var jug : (ArrayList<Jugador>) this.getJugadores()) 
    ...
    public int getCosteEntrenador(){
        ...
        var coste = this.getEntrenador().getFicha();
        return coste;
    }
    ...
    public int getCosteEquipoTecnico(){
        ...
        var coste = SALARIO_BASE + (int) (this.getEntrenador().getFicha() * 0.10);
    ...
    public int getCosteOjeadores(){
        ...
        var coste = SALARIO_BASE + (this.getOjeadores() * 10 - 10);
    ...
    public int pagarFichas(){
        var cantidad = this.getCosteFichas();
        this.setPresupuesto(this.getPresupuesto() - cantidad);
        return cantidad;
    }
    ...
    public int pagarMantenimientoEstadio(){
        ...
        var cantidad = 0;
        var min = (this.getCampo() * 5) * 25 / 100;
        var max = (this.getCampo() * 5) * 75 / 100;
        
        if (obtener(10)) {
            cantidad = valorAleatorio(min, max);
            this.setPresupuesto(this.getPresupuesto() - cantidad);
        }
    ...
    public int pagarGestion(){
        ...
        if (obtener(10)) {
            cantidad = valorAleatorio(this.getPublicidad() * CANTIDAD_BASE);
            this.setPresupuesto(this.getPresupuesto() - cantidad);
        }       
    ...
    public int perderContratosPublicitarios(int numero){
     ...
     public int ganarContratosPublicitarios(int numero){
        ...
        var actuales = this.getPublicidad();
    ...
    public String getNombreCampo() {
        ...
        nombreCampo = truncate(nombreCampo, 50);
        return nombreCampo;
    }
    ...
    public void setNombreCampo(String nombreCampo) {
        if (nombreCampo == null)
            ...
            this.nombreCampo = removeCharsEspeciales(nombreCampo);
    }
    ...
    private static class PresupuestoComparator implements Comparator<Equipo> {
        ...
        public int compare(Equipo o1, Equipo o2) {
            ...
            return valueOf(o1.getPresupuesto()).compareTo(o2.getPresupuesto());
        }
    }
