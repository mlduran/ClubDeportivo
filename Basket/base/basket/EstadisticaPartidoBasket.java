 ...
 * @author Miguel
 */
public final class EstadisticaPartidoBasket extends Estadistica{
    ...
    public EstadisticaPartidoBasket(){}
    
    public EstadisticaPartidoBasket(PartidoBasket partido){
        
        EquipoBasket eqLoc = (EquipoBasket) partido.getEqLocal();
        ...
        EquipoBasket eqVisit = (EquipoBasket) partido.getEqVisitante();
