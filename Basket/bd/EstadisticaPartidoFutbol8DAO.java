...
public class EstadisticaPartidoFutbol8DAO extends ObjetoDAO{
    ...
    protected String schema(){return "futbol8" + EstadisticaPartidoFutbol8DAO.getEntorno();}
    protected String nombreTabla() {
        return TablasDAO.estadisticaspartidofutbol8.name();
    }
    ...
    protected PreparedStatement asignarCampos(PreparedStatement sql, Object obj,
        ...
        EstadisticaPartidoFutbol8 objest = (EstadisticaPartidoFutbol8) obj;
        ...
        if (tipo == TipoSaveDAO.update) sql.setLong(44, objest.getId());
    ...
    protected Object crearObjeto(ResultSet retorno)
        ...
        EstadisticaPartidoFutbol8 obj = new EstadisticaPartidoFutbol8();
